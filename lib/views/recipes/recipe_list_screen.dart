    ...
    return Consumer<RecipeViewModel>(
      builder: (context, viewModel, child) {
        return CupertinoPageScaffold(
          navigationBar: const CupertinoNavigationBar(middle: Text('Recipes')),
          child: SafeArea(
            child:
                viewModel.isLoading
                            ...
                            child:
                                viewModel.featuredRecipes.isEmpty
                                    ...
                                    : ListView.builder(
                                      ...
                                      itemCount:
                                          viewModel.featuredRecipes.length,
                                      itemBuilder: (context, index) {
                                        return FeaturedRecipeCard(
                                          recipe:
                                              viewModel.featuredRecipes[index],
                                        );
                                      },
                                    ),
                          ),
                              ...
                              delegate: SliverChildBuilderDelegate(
                                (context, index) {
                                  ...
                                  final categoryRecipes =
                                      viewModel.categorizedRecipes[category]!;
