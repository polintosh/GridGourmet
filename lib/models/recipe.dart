  ...
  static List<Recipe> getMockRecipes() {
    return [
      ...
      Recipe(
        ...
        area: 'Italian',
        instructions:
            'Bring a large saucepan of salted water to the boil. Add the pasta, stir once and cook for about 10 minutes...',
        thumbnailUrl:
      ...
      Recipe(
        ...
        area: 'Indian',
        instructions:
            'Heat oil in a large saucepan over medium heat. Cook onion and garlic, stirring...',
        thumbnailUrl:
      ...
      Recipe(
        ...
        area: 'French',
        instructions:
            'Heat the oil in a large pan. Add the bacon and fry until crisp...',
        thumbnailUrl:
      ...
      Recipe(
        ...
        area: 'Mexican',
        instructions:
            'Preheat grill to medium-high heat. Brush fish with oil and season with cumin, salt, and pepper...',
        thumbnailUrl:
      ...
      Recipe(
        ...
        area: 'Japanese',
        instructions:
            'Heat oil in a large pot over medium heat. Add garlic and ginger...',
        thumbnailUrl:
